...
export type TaskBackend = {
    register: <TData, TResult>(params: RegisterTaskParams<TData, TResult>) => Task<TData, TResult>;
};
export declare function createTaskBackend<TImpl extends TaskBackend>(impl: TImpl): TImpl;
