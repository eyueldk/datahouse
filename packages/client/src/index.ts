...
import { DatahouseClient } from "./client";
...
export { DatahouseClient };

export function createClient<
  const TDatahouse extends AnyDatahouse = AnyDatahouse,
>(params: { baseUrl: string }): DatahouseClient<TDatahouse> {
  return new DatahouseClient<TDatahouse>({ baseUrl: params.baseUrl });
}
